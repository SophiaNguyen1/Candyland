...
Ms. Krasteva
Oct. 2018
This file draws and animates the Gummy Bears (part 3).
*/
...
public class GummyBearC extends Thread //creates a new class called GummyBearC and extends the thread
{
    ...
    private int gummyX = 500; //integer variable for the x location of the gummy bear
    ...
    public GummyBearC (Console con)  //first class constructor
    {
	c = con;
    ...
    public GummyBearC (Console con, Color n)  //second class constructor with a color parameter
    {
	c = con;
	gummyColor1 = n; //sets the gummy color to n
	gummyX = 550; //sets the gummy X coordinate to 550
    }


    public GummyBearC (Console con, Color n, int t)  //third class constructor with color and delay parameters
    {
	c = con;
	gummyColor1 = n; //sets the gummy color to n
	delay = t; //sets the delay to t
	gummyX = 600; //sets the gummy X coordinate to 600
    }
