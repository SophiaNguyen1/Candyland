...
Ms. Krasteva
Oct. 2018
This file draws and animates the Gummy Bears (part 1).
*/
...
public class GummyBearA extends Thread //creates a new class called GummyBearA and extends the thread
{
    ...
    private int gummyX = 700; //integer variable for the x location of the gummy bear
	...
	for (int i = 0 ; i < 400 ; i++)
	{
		...
		c.drawOval (gummyX + 32 - i, 437, 5, 5); //right hand outline
    ...
    public GummyBearA (Console con)  //first class constructor
    {
	c = con;
    ...
    public GummyBearA (Console con, Color n)  //second class constructor with a color parameter
    {
	c = con;
	gummyColor1 = n; //sets the gummy color to n
	gummyX = 750; //sets the gummy X coordinate to 750
    }


    public GummyBearA (Console con, Color n, int t)  //third class constructor with color and delay parameters
    {
	c = con;
	gummyColor1 = n; //sets the gummy color to n
	delay = t; //sets the delay to t
	gummyX = 800; //sets the gummy X coordinate to 800
    }
